...
void setup() {
  ...
  EEPROM.write(0, temperaturaUmbral);
  EEPROM.write(1, humedadUmbral);
  EEPROM.write(2, gmt);
...
{      
  ...
  lcd.print("OFF");
    ...
    temperaturaUmbral =  EEPROM.read(0);
    ...
    lcd.print(temperaturaUmbral);
      ...
      {
        EEPROM.update(0, temperaturaUmbral);
        estado = CHECK_BOTON;
      }
